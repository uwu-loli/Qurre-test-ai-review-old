...
[EntityWrapBindForFactory(typeof(Firearm))]
internal sealed class Gun : Item, IGun
{
    ...
    public AmmoTypes AmmoType => PrimaryAmmoContainerModule?.AmmoType.GetAmmoType() ?? AmmoTypes.None;
