...
public sealed class EffectsManager
{
    ...
    internal EffectsManager(Player player)
    {
        _player = player;
    }
    ...
    public StatusEffectBase? Get(EffectType effect)
    {
        ...
        Controller._effectsByType.TryGetValue(type, out var @base);
        return @base;
    }
    ...
    public bool TryGet(EffectType effect, out StatusEffectBase statusEffect)
    {
        ...
        if (Controller._effectsByType.TryGetValue(type, out var @base))
        {
            statusEffect = @base;
            return true;
        }
